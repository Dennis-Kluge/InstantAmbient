package instantambient.ambientclient.service;

import instantambient.ambientclient.db.AmbientData;
import instantambient.ambientclient.db.GeneralAmbientDB;
...
//            tmp = device.createRfcommSocketToServiceRecord(MY_UUID);
    ...
    public void writeData(){
		...
		if(AmbientData.getInstance().getRoomAmbientJson() != null){ 
			sb.append(AmbientData.getInstance().getRoomAmbientJson().toString());
			sb.append("\n");
			jString = sb.toString();

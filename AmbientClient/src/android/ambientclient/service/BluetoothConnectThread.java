...
public class BluetoothConnectThread extends Thread{
	 private static final UUID MY_UUID = UUID.fromString("AmbientConnector");
	private final BluetoothSocket bs;
	    ...
	    public BluetoothConnectThread(BluetoothDevice device) {
	        ...
	        try {
	            // MY_UUID is the appÕs UUID string, also used by the server code.
...
//	        mAdapter.cancelDiscovery();
	    ...
	    private void manageConnectedSocket(BluetoothSocket bs) {
			BluetoothConnectedThread bct = new BluetoothConnectedThread(bs);
			bct.start();
...
//		String string = "Hallo ihr da drau§en!";
